package ma.enset.bdccensetspringmvc.sec;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                // Je désactive CSRF pour la console H2

                .headers(headers -> headers.frameOptions(frame -> frame.sameOrigin()))
                // J'autorise l'affichage de la console H2 dans une iframe
                ...
                .authorizeHttpRequests(ar -> ar.requestMatchers("/h2-console/**", "/public/**", "/webjars/**").permitAll())
                // Console H2 et ressources publiques accessibles sans connexion
